            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <select class="form-control" v-model="add.kategori" required>
                  <option v-for="row in listKategoriPengeluaran" :key="row.id" :value="row">{{ row.nama_kategori }}</option>
                </select>  
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <select class="form-control" v-model="details.kategori" required>
                  <option v-for="row in listKategoriPegeluaran" :key="row.id" :value="row">{{ row.nama_kategori }}</option>
                </select>  
              </div>
            </div>
            <div class="form-group row">
